...
function renderHomeExtension(somaHome: string): string {
  return [
    ...
    '\tconst index = readOptional(`${SOMA_HOME}/memory/INDEX.md`);',
    '\treturn index.trim().length > 0 ? index : "Soma memory INDEX.md is empty or not yet built. Run `soma memory reindex` once durable notes exist.";',
    "}",
    "",
