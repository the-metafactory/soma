...
7. **Apply the 3-question test** (from references/eval-guide.md) to each criterion — drop any that fail
...
- The same 8-step loop structure (from references/optimize-loop.md)
