/**
 * Pure-logic renderer for the "VSA criteria" widget content lines.
 *
 * The Algorithm's per-VSA criteria are projected as a live checklist:
 *
...
const DEFAULT_HEADER = ["## VSA Criteria"] as const;
 ...
 */
export function renderVsaChecklistLines(
  criteria: readonly VsaChecklistCriterion[],
  options: VsaChecklistOptions = {},
): string[] {
...
// NOTE: A `summarizeVsaChecklist(criteria) → { total, passed,
// dropped, pending }` helper was previously reserved here for an
// "VSA 3/7" footer-status suffix. It was dropped because nothing
