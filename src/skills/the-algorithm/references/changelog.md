...
**Files updated:**
- NEW: `references/v6.2.0.md` (doctrine file)
...
- EDIT: `references/changelog.md` (this entry, plus Index demotion of v6.1.0 to Prior)
...
- EDIT: `references/capabilities.md` (Skill("ISA") added to OBSERVE-phase capabilities)
- EDIT: `references/mode-detection.md` (E1 fast-path bypass specified as whitelist, ISA skill invocation mandatory at E2+)
...
**Files updated:**
- NEW: `references/v6.0.0.md` (doctrine file)
...
- EDIT: `references/changelog.md` (this entry, plus Index demotion of v5.5.0 to Prior)
...
**Files updated:**
- `references/v5.5.0.md` (new doctrine; v5.4.0 copied with the Anti-criterion table row + provenance note rewritten)
...
- `references/optimize-loop.md` (Guard Rails + Eval mode guard rails examples renumbered)
...
**Files updated:**
- `references/v5.3.0.md` (new doctrine file, copy of v5.2.0 with category section rewritten)
