...
export function renderSomaAlgorithmExtension(options: RenderSomaAlgorithmExtensionOptions = {}): string {
  ...
  const policyModule = JSON.stringify(new URL("../../../policy-audit.ts", runtimeDir).href);
  const pathGuardModule = JSON.stringify(new URL("../../../policy-path-guard.ts", runtimeDir).href);
