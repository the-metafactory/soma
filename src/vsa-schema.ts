import type { AlgorithmEffortTier, VerificationStateArtifact } from "./types";
import { TWELVE_SECTIONS, getSection, SECTION_NAME_MAP } from "./vsa-accessors";

/**
 * Tier completeness gates — required VSA sections per effort tier.
 * Owned by the library (#34). The unified `VerificationStateArtifact` type stays
...
export function evaluateCompleteness(isa: VerificationStateArtifact, tier: AlgorithmEffortTier): CompletenessReport {
