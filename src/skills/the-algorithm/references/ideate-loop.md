...
Parameters control ideation behavior along a spectrum from pure free-form dreaming to tight analytical focus. Full schema: `references/parameter-schema.md`.

**Parameter resolution** (during OBSERVE phase):
1. Algorithm detects preset/focus/params from user request
2. Resolves to individual parameter values per `references/parameter-schema.md`
...
- The Meta-Learner (Phase 9) may adjust parameters within bounds per `references/parameter-schema.md`
