...
export const CURSOR_COMMUNICATION_PATH = ".cursor/rules/soma/COMMUNICATION.md";
...
export const CURSOR_HOME_FILE_PATHS = [
  ...
  // Declared for the planner / doctor / owned-subtree reconcile.
  CURSOR_COMMUNICATION_PATH,
  CURSOR_MCP_PATH,
] as const;
...
function renderCursorRules(): string {
  return [
    ...
    "Use `.cursor/rules/soma/MEMORY_LAYOUT.md`, `SKILLS.md`, `POLICY.md`, `COMMUNICATION.md`, and `ACTIVE_VSA.md` when those files are present.",
    "",
...
function renderCursorPolicy(input: ProjectionInput): string {
  ...
  return {
    ...
    files: [
      ...
      },
      {
        ...
        content: withProvenance("cursor", renderCursorPolicy(input)),
      },
      // Communication contract — omitted when the home has none. Verbatim bytes.
      ...communicationContractFile(input, CURSOR_COMMUNICATION_PATH),
      {
