...
function renderCursorRules(): string {
  return [
    ...
    "Use `.cursor/rules/soma/MEMORY_LAYOUT.md`, `SKILLS.md`, `POLICY.md`, and `ACTIVE_ISA.md` when those files are present.",
    "",
...
function renderCursorRulesReadme(): string {
  return [
    ...
    "- `ACTIVE_ISA.md` — current active ISA, omitted when none is active",
    "",
...
export function projectCursor(input: ProjectionInput): Projection {
  ...
  return {
    ...
    files: [
      ...
      ...activeIsaBundleFile("cursor", input.activeIsa),
    ],
  };
}
